    ...
    public class Log : BizProcess.Data.Interface.ILog
    {
        ...
        public int Add(BizProcess.Data.Model.Log model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				model.UserID == null ? new MySqlParameter("@UserID", MySqlDbType.VarChar, 36) { Value = DBNull.Value } : new MySqlParameter("@UserID", MySqlDbType.VarChar, 36) { Value = model.UserID },
				model.UserName == null ? new MySqlParameter("@UserName", MySqlDbType.VarChar, 50) { Value = DBNull.Value } : new MySqlParameter("@UserName", MySqlDbType.VarChar, 50) { Value = model.UserName },
				model.IPAddress == null ? new MySqlParameter("@IPAddress", MySqlDbType.VarChar, 50) { Value = DBNull.Value } : new MySqlParameter("@IPAddress", MySqlDbType.VarChar, 50) { Value = model.IPAddress },
				model.URL == null ? new MySqlParameter("@URL", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@URL", MySqlDbType.Text, -1) { Value = model.URL },
				model.Contents == null ? new MySqlParameter("@Contents", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@Contents", MySqlDbType.Text, -1) { Value = model.Contents },
				model.Others == null ? new MySqlParameter("@Others", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@Others", MySqlDbType.Text, -1) { Value = model.Others },
				model.OldXml == null ? new MySqlParameter("@OldXml", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@OldXml", MySqlDbType.Text, -1) { Value = model.OldXml },
				model.NewXml == null ? new MySqlParameter("@NewXml", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@NewXml", MySqlDbType.Text, -1) { Value = model.NewXml }
			};
        ...
        public DataTable GetPagerData(out string pager, string query = "", int size = 15, int number = 1, string title = "", string type = "", string date1 = "", string date2 = "", string userID = "")
        {
            ...
            if (!type.IsNullOrEmpty())
            {
                ...
                parList.Add(new MySqlParameter("@Type", MySqlDbType.VarChar) { Value = type });
            }
            if (date1.IsDateTime())
            {
