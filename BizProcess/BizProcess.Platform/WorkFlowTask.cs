...
{
    public class WorkFlowTask : IEqualityComparer<BizProcess.Data.Model.WorkFlowTask>
    {
        private WorkFlow bWorkFlow = new WorkFlow();
        private BizProcess.Data.Interface.IWorkFlowTask dataWorkFlowTask;
        private BizProcess.Data.Model.WorkFlowInstalled wfInstalled;
        private BizProcess.Data.Model.WorkFlowExecute.Result result;
        private List<BizProcess.Data.Model.WorkFlowTask> nextTasks = new List<BizProcess.Data.Model.WorkFlowTask>();
		public WorkFlowTask()
		{
        ...
        /// <returns></returns>
        public bool Equals(BizProcess.Data.Model.WorkFlowTask task1, BizProcess.Data.Model.WorkFlowTask task2)
        {
            return task1.ReceiveID == task2.ReceiveID;
        }

        public int GetHashCode(BizProcess.Data.Model.WorkFlowTask task)
        {
        ...
        public string GetStepSnderIDString(Guid flowID, Guid stepID, Guid groupID)
        {
            ...
            {
                sb.Append(BizProcess.Platform.Users.PREFIX);
                sb.Append(li);
                sb.Append(",");
            }
        ...
        /// <returns></returns>
        private BizProcess.Data.Model.WorkFlowExecute.Execute GetExecuteModel(string jsonString)
        {
            BizProcess.Data.Model.WorkFlowExecute.Execute execute = new BizProcess.Data.Model.WorkFlowExecute.Execute();
            BizProcess.Platform.Organize borganize = new Organize();
            ...
            { 
                case "submit":
                    execute.ExecuteType = BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Submit;
                    break;
                case "save":
                    execute.ExecuteType = BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Save;
                    break;
                case "back":
                    execute.ExecuteType = BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Back;
                    break;
            }
            ...
            Dictionary<Guid, List<BizProcess.Data.Model.Users>> steps = new Dictionary<Guid, List<BizProcess.Data.Model.Users>>();
        ...
        /// <param name="jsonString"></param>
        /// <returns></returns>
        public BizProcess.Data.Model.WorkFlowExecute.Result Execute(string jsonString)
        {
        ...
        /// <returns></returns>
        public BizProcess.Data.Model.WorkFlowExecute.Result Execute(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            result = new BizProcess.Data.Model.WorkFlowExecute.Result();
            nextTasks = new List<BizProcess.Data.Model.WorkFlowTask>();
            ...
            lock (executeModel.GroupID.ToString())
            {
                ...
                {
                    case BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Back:
                        executeBack(executeModel);
                        break;
                    //case BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Completed:
                    //    executeComplete(executeModel);
                    //    break;
                    case BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Save:
                        executeSave(executeModel);
                        break;
                    case BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Submit:
                    case BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Completed:
                        executeSubmit(executeModel);
                        break;
                    case BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Redirect:
        ...
        private void executeSubmit(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
            {
                //如果是第一步提交并且没有实例则先创建实例
                BizProcess.Data.Model.WorkFlowTask currentTask = null;
                ...
                foreach (var step in executeModel.Steps)
                {
                    foreach (var user in step.Value)
                    {
                        ...
                        if (isPassing)
                        {
                            BizProcess.Data.Model.WorkFlowTask task = new BizProcess.Data.Model.WorkFlowTask();
                            if (nextStep.WorkTime > 0)
                            {
                                task.CompletedTime = BizProcess.Utility.DateTimeNew.Now.AddHours((double)nextStep.WorkTime);
                            }
                            ...
                            task.ReceiveTime = BizProcess.Utility.DateTimeNew.Now;
                            ...
                            {
                                BizProcess.Data.Model.WorkFlowExecute.Execute subflowExecuteModel = new BizProcess.Data.Model.WorkFlowExecute.Execute();
                                if (!nextStep.Event.SubFlowActivationBefore.IsNullOrEmpty())
                                {
                                    object obj = ExecuteFlowCustomEvent(nextStep.Event.SubFlowActivationBefore.Trim(),
                                        new BizProcess.Data.Model.WorkFlowCustomEventParams()
                                        {
                                    ...
                                    if (obj is BizProcess.Data.Model.WorkFlowExecute.Execute)
                                    {
                                        subflowExecuteModel = obj as BizProcess.Data.Model.WorkFlowExecute.Execute;
                                    }
                                }
                                subflowExecuteModel.ExecuteType = BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Save;
        ...
        private void executeSave(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            //如果是第一步提交并且没有实例则先创建实例
            BizProcess.Data.Model.WorkFlowTask currentTask = null;
            bool isFirst = executeModel.StepID == wfInstalled.FirstStepID && executeModel.TaskID == Guid.Empty && executeModel.GroupID == Guid.Empty;
        ...
        private void executeBack(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            ...
            using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
            {
                List<BizProcess.Data.Model.WorkFlowTask> backTasks = new List<BizProcess.Data.Model.WorkFlowTask>();
                int status = 0;
                ...
                List<BizProcess.Data.Model.WorkFlowTask> tasks = new List<BizProcess.Data.Model.WorkFlowTask>();
                foreach (var step in executeModel.Steps)
                {
                ...
                if (isBack)
                {
                    foreach (var task in tasks.Distinct(this))
                    {
                        if (task != null)
                        {
                            BizProcess.Data.Model.WorkFlowTask newTask = task;
                            newTask.ID = Guid.NewGuid();
                            newTask.PrevID = currentTask.ID;
                            newTask.Note = "退回任务";
                            newTask.ReceiveTime = BizProcess.Utility.DateTimeNew.Now;
                            newTask.SenderID = currentTask.ReceiveID;
                            newTask.SenderName = currentTask.ReceiveName;
                            newTask.SenderTime = BizProcess.Utility.DateTimeNew.Now;
                            ...
                            {
                                newTask.CompletedTime = BizProcess.Utility.DateTimeNew.Now.AddHours((double)currentStep.WorkTime);
                            }
                            else
                            {
        ...
        private void executeComplete(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel, bool isCompleteTask = true)
        {
            ...
            if (parentTasks.Count > 0)
            {
                ...
                if (flowRunModel != null)
                {
                    ...
                    {
                        ExecuteFlowCustomEvent(steps.First().Event.SubFlowCompletedBefore.Trim(), new BizProcess.Data.Model.WorkFlowCustomEventParams()
                        {
        ...
        private void executeRedirect(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            BizProcess.Data.Model.WorkFlowTask currentTask = null;
            bool isFirst = executeModel.StepID == wfInstalled.FirstStepID && executeModel.TaskID == Guid.Empty && executeModel.GroupID == Guid.Empty;
            if (isFirst)
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        private bool IsPassing(BizProcess.Data.Model.WorkFlowInstalledSub.Step step, Guid flowID, Guid groupID, Guid taskID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        private bool IsBack(BizProcess.Data.Model.WorkFlowInstalledSub.Step step, Guid flowID, Guid groupID, Guid taskID)
        {
            var tasks = GetTaskList(flowID, step.ID, groupID).FindAll(p => p.PrevID == taskID);
            if (tasks.Count == 0)
            {
        ...
        /// <returns></returns>
        private BizProcess.Data.Model.WorkFlowTask createFirstTask(BizProcess.Data.Model.WorkFlowExecute.Execute executeModel, bool isSubFlow = false)
        {
            ...
            {
                task.CompletedTime = BizProcess.Utility.DateTimeNew.Now.AddHours((double)nextSteps.First().WorkTime);
            }
            task.FlowID = executeModel.FlowID;
        ...
        {
            return dataWorkFlowTask.GetTasks(userID, out pager, query, title, flowid, BizProcess.Platform.Users.RemovePrefix(sender), date1, date2, type);
        }
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetTaskList(Guid flowID, Guid stepID, Guid groupID)
        {
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetTaskListByStepID(Guid taskID, Guid stepID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetPrevTaskList(Guid taskID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetNextTaskList(Guid taskID)
        {
        ...
        /// <param name="stepID"></param>
        /// <returns></returns>
        public Dictionary<Guid, string> GetBackSteps(Guid taskID, int backType, Guid stepID, BizProcess.Data.Model.WorkFlowInstalled wfInstalled)
        {
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetUserTaskList(Guid flowID, Guid stepID, Guid groupID, Guid userID)
        {
        ...
        /// <returns></returns>
        public string DesignateTask(Guid taskID, BizProcess.Data.Model.Users user)
        {
            var task = Get(taskID);
            if (task == null)
            {
        ...
        public string BackTask(Guid taskID)
        {
            ...
            BizProcess.Data.Model.WorkFlowExecute.Execute executeModel = new BizProcess.Data.Model.WorkFlowExecute.Execute();
            executeModel.ExecuteType = BizProcess.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Back;
            ...
            Dictionary<Guid, List<BizProcess.Data.Model.Users>> execSteps = new Dictionary<Guid, List<BizProcess.Data.Model.Users>>();
            var backsteps = GetBackSteps(taskID, steps.First().Behavior.BackType, task.StepID, wfInstalled);
            foreach (var back in backsteps)
            {
                execSteps.Add(back.Key, new List<BizProcess.Data.Model.Users>());
            }
        ...
        public List<BizProcess.Data.Model.WorkFlowTask> Sort(List<BizProcess.Data.Model.WorkFlowTask> tasks)
        {
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetBySubFlowGroupID(Guid subflowGroupID)
        {
