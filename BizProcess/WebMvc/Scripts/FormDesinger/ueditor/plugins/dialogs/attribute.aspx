...
<%
    ...
    BizProcess.Platform.WorkFlowForm bworkflowform = new BizProcess.Platform.WorkFlowForm();
    string link_DBConnOptions = bdbConn.GetAllOptions();
    string typeOptions = bworkflowform.GetTypeOptions("");
    string validatePromptType = new BizProcess.Platform.WorkFlowForm().GetValidatePropTypeRadios("validatealerttype","","");
%>
<br />
