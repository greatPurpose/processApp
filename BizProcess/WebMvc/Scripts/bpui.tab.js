...
;BPUI.Tab = function (options)
{
    ...
    this.init = function ()
    {
        ...
        if (instance.opts.contextmenu)
        {
            try
            {
                ...
                contextMenu = new BPUI.Menu({ srcElement: $tabTitleUL });
    ...
    {
        return id && this.$tabDiv.children(".tab_title").children("ul").children("li[itemid='" + id + "']").size() == 0 ? id : "tab_" + BPUI.Core.newid(false);
    };
