//选择图标
;BPUI.SelectIco = function (options)
{
    var instance = this;
    var defaults = {
        obj: null,
    ...
    else
    {
        ...
        {
            new BPUI.Window().open({
                id: "ico_" + id, title: title, width: 600, height: 406,
                url: top.rootdir + '/Controls/SelectIco/Index?more=' + more + '&id=' + id + '&source=' + source + '&values=' + val, openerid: BPUI.Core.query("tabid")
            });
        });
    }
